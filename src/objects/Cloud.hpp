...
public:
	...
	void generate() {
		...
		this->internalPositions[1] = glm::vec3(0.85 + 0.4 * radius[1] * std::rand() / RAND_MAX, 0.0f, 0.0f);
		this->internalPositions[2] = glm::vec3(-0.85f - 0.4 * radius[2] * std::rand() / RAND_MAX, 0.0f, 0.0f);
